...
import (
	...
	"github.com/Inspirate789/rpcx/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/Inspirate789/rpcx/server"`)
	fmt.Fprintln(w, `  "github.com/Inspirate789/rpcx/serverplugin"`)
